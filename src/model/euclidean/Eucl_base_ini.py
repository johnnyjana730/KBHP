...
class Eucl_base_ini(nn.Module):
    def __init__(self, args, n_entity, n_relation):
        super(Eucl_base_ini, self).__init__()
        self._parse_args(args, n_entity, n_relation)
        # self._build_embeddings()        

        self.entity_emb_matrix = nn.Embedding(self.n_entity, self.dim)
        torch.nn.init.xavier_uniform(self.entity_emb_matrix.weight)
        ...
        torch.nn.init.xavier_uniform(self.rela_plus_emb_matrix.weight)
        ...
        torch.nn.init.xavier_uniform(self.relation_emb_matrix.weight)
